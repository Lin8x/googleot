...
try:
    ...
    time.sleep(3)
    print(green + bold + "[ OK ] Installed new version of googleot" + rr)
    ...
    subprocess.call("sudo mv /usr/var/googleot {}".format(install_location), shell=True)
    ...
    if had_error:
        print(red + bold + "[!] Error updating googleot" + rr)
    else:
